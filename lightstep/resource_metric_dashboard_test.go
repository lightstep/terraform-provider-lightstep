		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceNameSpans, "chart.0.query.0.spans.0.final_window_operation.0.operator", "min"),
					resource.TestCheckResourceAttr(resourceNameSpans, "chart.0.query.0.spans.0.final_window_operation.0.input_window_ms", "30000"),
				),
			},
			{
