		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "chart.0.workflow_link.#", "2"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "workflow_link.0.name", "test dashboard link"),
					resource.TestCheckResourceAttr(resourceName, "workflow_link.0.url", "https://test.com"),
					resource.TestCheckResourceAttr(resourceName, "workflow_link.1.name", "another test dashboard link"),
					resource.TestCheckResourceAttr(resourceName, "workflow_link.1.url", "https://anothertest.com"),
					resource.TestCheckResourceAttr(resourceName, "chart.#", "1"),
					...
					resource.TestCheckResourceAttr(resourceName, "chart.0.workflow_link.0.url", "https://anothertestchart.com"),
				),
			},
		},
	})
